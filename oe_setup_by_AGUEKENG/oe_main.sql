...
DEFINE data_path = C:\oe_setup_by_AGUEKENG
PROMPT
PROMPT writeable directory path for the log files as parameter 7:
DEFINE log_path = C:\oe_setup_by_AGUEKENG
PROMPT
...
DEFINE vscript = C:\oe_setup_by_AGUEKENG\coe_&vrs
...
DEFINE vscript = C:\oe_setup_by_AGUEKENG\loe_&vrs
...
DEFINE vscript = C:\oe_setup_by_AGUEKENG\poe_&vrs
@&vscript &vrs 
...
@C:\oe_setup_by_AGUEKENG\oc_main

--
-- statistics
--

@C:\oe_setup_by_AGUEKENG\oe_analz
...
CONNECT oe/oe@//localhost:1521/xepdb1
prompt "----------------------------------BY PHARAON-------------------------------"
prompt "BY PHARAON"
prompt "BY PHARAON"
prompt "----------------------------------BY PHARAON-------------------------------"
